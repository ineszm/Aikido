...
TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView=header.findViewById(R.id.nom_client);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            Intent intent=new Intent(Menu_client.this,Login.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_exercice) {
          fragment=new Exercice_client();
        } else if (id == R.id.nav_ajouter) {
            fragment=new Ajout_ActC();

        }
        else if (id == R.id.nav_coach) {
         fragment=new Conversation_client();
        }
        else if(id==R.id.nav_aikido)
        {
            fragment=new Apropos_cl();
        }
        else if(id==R.id.nav_prog)
        { fragment=new Consulter_progC();

        }
        else if(id==R.id.nav_profil)
        {
          fragment=new Profil_cli();
        }
